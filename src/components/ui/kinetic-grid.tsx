...
export default function KineticGrid({ children, className, globalColor = 'default' }: KineticGridProps) {
  ...
  // Mouse coordinates are container-relative (not viewport-relative) so the
  // effect stays correctly scoped when this is embedded as a page section
  // rather than used as a full-page background.
