    ...
    <Reveal>
      <div className="grid gap-5 sm:grid-cols-2">
        <div className="panel rounded-2xl p-6">
          ...
          <h3 className="mt-3 text-lg font-semibold text-ink">CRUD</h3>
          <p className="text-xs font-semibold uppercase tracking-wide text-ink/35">A data operation concept</p>
        ...
        <div className="panel rounded-2xl p-6">
          ...
          <h3 className="mt-3 text-lg font-semibold text-ink">REST</h3>
          <p className="text-xs font-semibold uppercase tracking-wide text-ink/35">An API architectural style</p>
          <p className="mt-3 text-sm leading-relaxed text-ink/60">
