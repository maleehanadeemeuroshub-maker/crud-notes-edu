    ...
    <div className="flex flex-col gap-3">
      <div className="relative">
        ...
        <input
          ...
          className="focus-ring panel h-11 w-full rounded-lg pl-9 pr-3 text-sm text-white placeholder:text-white/35 transition-all duration-300 focus:scale-[1.005] focus:border-indigo-400/50 focus:shadow-[0_0_0_4px_rgba(99,102,241,0.14)]"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative">
          <select
            ...
            className="focus-ring panel h-9 appearance-none rounded-lg py-0 pl-3 pr-8 text-xs font-medium text-white/80"
          >
        ...
        <button
          ...
          className={cn(
            ...
            filters.favoriteOnly
              ...
              : 'panel text-white/60 hover:text-white/90',
          )}
        >
