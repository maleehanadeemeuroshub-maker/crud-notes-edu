    ...
    <Reveal>
      <div className="grid gap-5 sm:grid-cols-2">
        <div className="panel rounded-2xl p-6">
          ...
          <h3 className="mt-3 text-lg font-semibold text-slate-900">SQL Databases</h3>
          ...
          <div className="mt-4 flex flex-wrap gap-1.5">
            {SQL_DBS.map((db) => (
              <span key={db} className="font-mono rounded-md border border-slate-900/10 bg-slate-900/[0.03] px-2 py-1 text-xs text-slate-900/55">
                {db}
              </span>
            ))}
          </div>
        ...
        <div className="panel rounded-2xl p-6">
          <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-400/10 text-indigo-600">
            <Braces className="h-5 w-5" />
          </span>
          <h3 className="mt-3 text-lg font-semibold text-slate-900">NoSQL Databases</h3>
          <p className="mt-2 text-sm leading-relaxed text-slate-900/60">
      ...
      <p className="mt-4 text-center text-sm text-slate-900/45">
